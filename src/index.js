...
function generatePoem(event) {
    ...
    let context = "You are a romantic Poem expert and love to write poems. Your mission is to generate a short four line poem in basic html and in italics. The poem should not be long and separate each line with a <br />. Make sure to follow the user instructions below. Do NOT include a title and sign the BOTTOM of the poem with 'SheCodes AI' in a <strong> element"
